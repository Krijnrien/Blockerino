...
public abstract class Entity extends WorldObject {
	...
	private int weight;//weight of Server.game.entity
	private Vector2f size;
	private AABB hitBounds;// Bounds Server.game.entity for hits
	private AABB bounds; //bounds Server.game.entity for collision
