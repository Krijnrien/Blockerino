package blockerino.entity.character.equipment.combat.weapon.projectile;

import blockerino.entity.character.equipment.combat.bullet.Bullet;
import blockerino.entity.character.equipment.combat.weapon.Weapon;

import java.util.ArrayList;

public abstract class ProjectileWeapon extends Weapon {

    //TODO Bullet has a callback from Server.game.entity or surface it hit, determining it's damage, hit, remaining traveling speed etc.
